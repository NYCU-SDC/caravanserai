...
func TestReconcileProjectsSkipsBusyProject(t *testing.T) {
	...
	reconcileProjects(context.Background(), client, rt, nil, &BackupSupport{Coordinator: coordinator}, nil, false, zap.NewNop())
...
func TestReconcileProjectsWithoutBackupSupport(t *testing.T) {
	...
	reconcileProjects(context.Background(), client, rt, nil, nil, nil, false, zap.NewNop())
